        ...
        <footer style={{backgroundColor: "rgb(250, 250, 250)"}}>
            <div className='container border-top mt-5'>
                <div className='row mt-5 mb-4'>
                    <div className='col'>
                        <img src='media/images/logo.svg' alt='logo' style={{width: "75%"}} className='mb-2' />
                        <p style={{fontSize: "14.2px", marginTop: "23px"}} className='mb-4'>&copy; 2010 - 2026, Zerodha Broking Ltd.<br/> All rights reserved.</p>
                        <div className='text-muted'>
                            <div className='icons'><i class="fa-brands fa-x-twitter"></i></div>
                            <div className='icons'><i class="fa-brands fa-square-facebook"></i></div>
                            <div className='icons'><i class="fa-brands fa-instagram"></i></div>
                            <div className='icons'><i class="fa-brands fa-linkedin-in"></i></div>
                        </div>
                    </div>
                ...
                <div className='mt-5 text-muted' style={{fontSize: "12px"}}>
                    ...
                    <p>"Prevent unauthorised transactions in your account. Update your mobile numbers/email IDs with your stock brokers. Receive information of your transactions directly from Exchange on your mobile/email at the end of the day. Issued in the interest of investors. KYC is one time exercise while dealing in securities markets - once KYC is done through a SEBI registered intermediary (broker, DP, Mutual Fund etc.), you need not undergo the same process again when you approach another intermediary." Dear Investor, if you are subscribing to an IPO, there is no need to issue a cheque. Please write the Bank account number and sign the IPO application form to authorize your bank to make payment in case of allotment. In case of non allotment the funds will remain in your bank account. As a business we don't give stock tips, and have not authorized anyone to trade on behalf of others. If you find anyone claiming to be part of Zerodha and offering such services, please <a href='#' style={{textDecoration: "none"}}>create a ticket</a> here.</p>
