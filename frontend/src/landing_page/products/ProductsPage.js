...
function ProductsPage() {
    return ( 
        <>
            ...
            <p className='text-center mt-5 mb-5 fs-4'>Want to know more about our technology stack? Check out the <a style={{textDecoration: "none", color: "#2f6ecb"}} href=''>Zerodha.tech</a> blog.</p>
            <Universe/>
        </>
     );
}
