    ...
    return ( 
        <div className='container'>
            <div className='row p-5 mt-5'>
                ...
                <div className='col-4 p-5 mt-2 mb-2'>
                    <h4 className='fs-5 mb-4'><i class="fa-solid fa-chart-column"></i>  Your Zerodha Account</h4>
                ...
                <div className='col-4 p-5 mt-2 mb-2'>
                    <h4 className='fs-5 mb-4'><i class="fa-regular fa-credit-card"></i>  Funds</h4>
                ...
                <div className='col-4 p-5 mt-2 mb-2'>
                    <h4 className='fs-5 mb-4'><i class="fa-solid fa-circle-notch"></i>  Console</h4>
                ...
                <div className='col-4 p-5 mt-2 mb-2'>
                    <h4 className='fs-5 mb-4'><i class="fa-solid fa-coins"></i>  Coin</h4>
